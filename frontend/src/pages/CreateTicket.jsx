    ...
    try {
      ...
      if (images.length > 0) {
        ...
        for (const file of images) {
          await uploadAttachment(newTicketId, file)
        }
      }
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            <div style={{ flex: 1 }}>
              ...
              <CustomSelect value={category} options={['Hardware', 'Software', 'Network', 'Other']} onChange={setCategory} />
            </div>
            <div style={{ flex: 1 }}>
              <label style={{ display: 'block', marginBottom: '8px' }}>Priority</label>
              <CustomSelect value={priority} options={['Low', 'Medium', 'High']} onChange={setPriority} />
            </div>
          </div>
        </div>
